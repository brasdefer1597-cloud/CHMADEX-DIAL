...
import { Zap, ExternalLink, Shuffle, Sparkles, ThumbsUp, ThumbsDown, RefreshCw } from 'lucide-react';
...
interface ResultsDisplayProps {
  ...
  setFeedback: (f: 'liked' | 'disliked' | null) => void;
  onRegenerate: () => void;
}
        ...
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              aria-label="Dislike synthesis"
            >
              <ThumbsDown className="w-3 h-3" />
            </button>
            <button onClick={onRegenerate} className="p-1.5 rounded-lg hover:bg-white/5 text-slate-600 transition-colors" title="Regenerar Síntesis" aria-label="Regenerate">
