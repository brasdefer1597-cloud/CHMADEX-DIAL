...
const App: React.FC = () => {
  // ⚡ Bolt: Replaced controlled input (useState) with uncontrolled input (useRef).
  // This prevents the entire App component from re-rendering on every single keystroke,
  // significantly improving typing performance in the main textarea.
          ...
          <main className="space-y-5">
            <div className="relative group">
              <textarea
                ...
                // ⚡ Bolt: Uncontrolled component mapping
                defaultValue=""
                ref={inputRef}
              />
