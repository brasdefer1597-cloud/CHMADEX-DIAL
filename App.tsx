...
const App: React.FC = () => {
  // Bolt ⚡ Optimization: Using uncontrolled input (useRef) instead of controlled state (useState)
  // for the main text area prevents the entire heavy App component from re-rendering on every single keystroke.
  // We only need the value when clicking Process or Disrupt.
