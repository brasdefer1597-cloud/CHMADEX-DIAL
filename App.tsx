...
const App: React.FC = () => {
  // ⚡ Bolt: Using uncontrolled textarea with useRef instead of useState.
  // This prevents the entire App component from re-rendering on every single keystroke.
  // Expected Impact: Significantly reduces React rendering overhead and prevents lag during typing.
