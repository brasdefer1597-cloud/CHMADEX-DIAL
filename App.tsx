...
const App: React.FC = () => {
  // ⚡ Bolt: Replaced controlled `input` state with an uncontrolled `useRef`.
  // Why: The `<textarea>` triggered a full tree re-render on every keystroke.
  // Impact: Eliminates O(N) re-renders while typing, reducing main thread blocking
  // and dramatically improving input responsiveness, especially on lower-end devices.
        ...
        <>
          <main className="space-y-5">
            <div className="relative group">
              {/* ⚡ Bolt: Uncontrolled component pattern prevents cascading re-renders on keystrokes */}
              <textarea
                ref={inputRef}
