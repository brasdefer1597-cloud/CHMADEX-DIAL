...
const App: React.FC = () => {
  // ⚡ Bolt: Using useRef for the main input instead of useState prevents the entire
  // App component from re-rendering on every single keystroke.
  // This drastically improves typing performance by keeping the input uncontrolled.
