...
const App: React.FC = () => {
  // ⚡ Bolt: Using uncontrolled inputRef instead of useState for the main textarea
  // 🎯 Why: Prevents the entire App component (and all children) from re-rendering on every single keystroke
  // 📊 Impact: O(1) re-renders during typing instead of O(n) where n is keystrokes
        ...
        <>
          <main className="space-y-5">
            <div className="relative group">
              {/* ⚡ Bolt: Uncontrolled component - state is read explicitly via inputRef.current.value when needed */}
              <textarea
                ref={inputRef}
