...
const App: React.FC = () => {
  // ⚡ Bolt: Using useRef instead of useState for the main textarea
  // to prevent full App re-renders on every keystroke.
  // Impact: O(1) rendering cost for typing instead of O(n) component tree re-renders.
  ...
  const handleProcess = async () => {
    ...
    try {
      const data = await chalamandra.runDialectic(inputValue, thesisStyle, antithesisStyle, (msg) => {
