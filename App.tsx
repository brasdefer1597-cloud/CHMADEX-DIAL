...
const App: React.FC = () => {
  // ⚡ Bolt: Using an uncontrolled textarea with useRef to prevent full application
  // re-renders on every keystroke, which is a significant performance bottleneck.
