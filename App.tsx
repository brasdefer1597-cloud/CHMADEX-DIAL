...
const App: React.FC = () => {
  ...
  // This prevents the entire App component from re-rendering on every single keystroke,
  // significantly improving typing performance, especially on lower-end devices or large inputs.
        ...
        <>
          <main className="space-y-5">
            <div className="relative group">
              {/* ⚡ Bolt Optimization: Uncontrolled textarea using defaultValue instead of value/onChange */}
              <textarea
                ref={inputRef}
