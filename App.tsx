...
const App: React.FC = () => {
  // ⚡ Bolt: Using useRef for the main input instead of useState to prevent full App re-renders on every keystroke.
  // Impact: Reduces re-renders from O(N) (N = keystrokes) to O(1) during typing, saving significant CPU cycles and preventing lag in rendering complex SVG children.
