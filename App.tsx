...
const App: React.FC = () => {
  // ⚡ Bolt: Using useRef instead of useState for high-frequency text input to prevent
  // full component tree re-renders on every keystroke, significantly improving typing performance.
