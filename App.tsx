...
const App: React.FC = () => {
  // ⚡ Bolt: Using useRef for uncontrolled textarea prevents full App re-renders on every keystroke.
  // Impact: Reduces React re-renders by 100% during typing, drastically improving input responsiveness in this large component.
